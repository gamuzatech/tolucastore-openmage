...
SQLBLOCK;
    ...
    $installer->getConnection ()
        ->addColumn ($table, 'bundle_id', array(
            'type'     => Varien_Db_Ddl_Table::TYPE_INTEGER,
            'length'   => 11,
            'unsigned' => true,
            'nullable' => false,
    ...
    $installer->getConnection ()
        ->addColumn ($table, 'is_muted', array(
            'type'     => Varien_Db_Ddl_Table::TYPE_INTEGER,
            'length'   => 11,
            'unsigned' => true,
            'nullable' => false,
    ...
    $installer->getConnection ()
        ->addColumn ($table, 'is_notified', array(
            'type'     => Varien_Db_Ddl_Table::TYPE_INTEGER,
            'length'   => 11,
            'unsigned' => true,
            'nullable' => false,
...
addBotChatTable ($installer, Toluca_Bot_Helper_Data::CHAT_TABLE, 'Toluca Bot Chat');
