...
class Toluca_Bot_Model_Api_Resource_Abstract extends Mage_Api_Model_Resource_Abstract
{
    ...
    protected $_paymentMethods = array(
        '21' => 'cashondelivery',
        '22' => 'machineondelivery',
        '23' => 'banktransfer',
        '24' => 'checkmo',

        '25' => 'gamuza_pagcripto_payment',
        '26' => 'gamuza_picpay_payment',
        '27' => 'gamuza_openpix_payment',
    ...
    protected function _saveTool ($name, $path, $chat, $type = Toluca_Bot_Helper_Data::TOOL_TYPE_FUNCTION, $body = null, $result = null, $messageId = null)
    {
