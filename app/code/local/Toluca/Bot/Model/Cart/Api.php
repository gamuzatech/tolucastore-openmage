...
class Toluca_Bot_Model_Cart_Api extends Toluca_Bot_Model_Api_Resource_Abstract
{
    ...
    public function order ($shippingId = null, $shippingName = null, $paymentId = null, $paymentName = null)
    {
        $result = null;
    ...
    public function clear ()
    {
        ...
        try
        {
            ...
            $result = Mage::helper ('bot/message')->getCustomerCartDeletedText () . PHP_EOL . PHP_EOL;
        }
        catch (Mage_Api_Exception $e)
        {
            $result = Mage::helper ('bot')->__('Obs: %s', $e->getCustomMessage ()) . PHP_EOL . PHP_EOL;
