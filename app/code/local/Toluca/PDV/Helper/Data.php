...
class Toluca_PDV_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    const XML_PATH_PDV_SETTING_SITEF       = 'pdv/setting/sitef';
    ...
    const XML_PATH_PDV_CASHIER_SHOW_OPERATOR_ORDERS = 'pdv/cashier/show_operator_orders';
    const XML_PATH_PDV_CASHIER_SHOW_PENDING_ORDERS = 'pdv/cashier/show_pending_orders';
    ...
    const XML_PATH_PDV_CHECKOUT_WAIT_PENDING_ORDERS = 'pdv/checkout/wait_pending_orders';
