...
class Gamuza_Sitef_Adminhtml_Sitef_Pinpad_TransactionController extends Mage_Adminhtml_Controller_Action
{
	...
	{
		$this->loadLayout ()
            ->_setActiveMenu ('gamuza/sitef/pinpad_transaction')
            ->_addBreadcrumb(
