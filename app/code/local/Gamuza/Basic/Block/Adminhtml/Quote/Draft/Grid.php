...
class Gamuza_Basic_Block_Adminhtml_Quote_Draft_Grid
    extends Mage_Adminhtml_Block_Widget_Grid
{
	public function __construct ()
	{
		...
		$this->setId ('basicQuoteDraftGrid');
	...
	{
		$collection = Mage::getModel ('basic/quote_draft')->getCollection ();
	...
	protected function _prepareColumns ()
	{
		...
		$this->addColumn ('increment_id', array(
		    'header'  => Mage::helper ('basic')->__('Quote Draft #'),
		    'index'   => 'increment_id',
		));
		...
		$this->addColumn ('state', array(
		    ...
		    'index'   => 'state',
            'type'    => 'options',
            'options' => Mage::getModel ('basic/adminhtml_system_config_source_quote_draft_state')->toArray (),
		));
