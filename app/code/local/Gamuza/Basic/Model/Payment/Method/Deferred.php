...
class Gamuza_Basic_Model_Payment_Method_Deferred extends Mage_Payment_Model_Method_Cashondelivery
{
    ...
    public function assignData($data)
    {
        ...
        if ($data->getInstallmentsQty() !== null)
        {
            $info->setDeferredInstallmentsQty($data->getInstallmentsQty());
        }

        if ($data->getIntervalDays() !== null)
        {
            $info->setDeferredIntervalDays($data->getIntervalDays());
        }

        if ($data->getFirstDueDays() !== null)
        {
            $info->setDeferredFirstDueDays($data->getFirstDueDays());
        }
