 ...
 * Product Age Gate
 */
$installer->addAttribute ('catalog_product', Gamuza_Basic_Helper_Data::PRODUCT_ATTRIBUTE_AGE_GATE, array(
    'group'            => Mage::helper ('basic')->__('General'),
    'label'            => Mage::helper ('basic')->__('Age Gate'),
    'note'             => Mage::helper ('basic')->__('Age Verification System'),
...
$installer->addAttribute ('catalog_product', Gamuza_Basic_Helper_Data::PRODUCT_ATTRIBUTE_PRINTER_ID, array(
    ...
    'global'           => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_GLOBAL,
    'source'           => 'basic/eav_entity_attribute_source_product_printer',
    'type'             => 'int',
    'input'            => 'select',
    'visible'          => true,
    'required'         => false,
 ...
 * Product Weekday IDs
 */
$installer->addAttribute ('catalog_product', Gamuza_Basic_Helper_Data::PRODUCT_ATTRIBUTE_WEEKDAY_IDS, array(
    'group'            => Mage::helper ('basic')->__('General'),
    'label'            => Mage::helper ('basic')->__('Weekdays'),
    'global'           => Mage_Catalog_Model_Resource_Eav_Attribute::SCOPE_GLOBAL,
    'source'           => 'basic/eav_entity_attribute_source_product_weekday',
    'type'             => 'varchar',
    'input'            => 'multiselect',
    'visible'          => true,
    'required'         => false,
