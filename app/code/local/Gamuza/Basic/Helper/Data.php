...
class Gamuza_Basic_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    const CUSTOMER_ATTRIBUTE_IS_ACTIVE = 'is_active';
    ...
    const PAYMENT_ATTRIBUTE_DEFERRED_FEE_PERCENTAGE   = 'deferred_fee_percentage';
    const PAYMENT_ATTRIBUTE_DEFERRED_FEE_AMOUNT       = 'deferred_fee_amount';
