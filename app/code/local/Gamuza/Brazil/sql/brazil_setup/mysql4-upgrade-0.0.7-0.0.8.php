...
function addBrazilCountryTable ($installer, $model, $description)
{
...
addBrazilCountryTable ($installer, Gamuza_Brazil_Helper_Data::COUNTRY_TABLE, 'Gamuza Brazil Country');
