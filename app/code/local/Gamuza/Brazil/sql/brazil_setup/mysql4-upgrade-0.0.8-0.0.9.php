...
function addBrazilRegionTable ($installer, $model, $description)
{
...
addBrazilRegionTable ($installer, Gamuza_Brazil_Helper_Data::REGION_TABLE, 'Gamuza Brazil Region');
