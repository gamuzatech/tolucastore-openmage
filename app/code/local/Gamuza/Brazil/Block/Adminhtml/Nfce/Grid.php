...
*/
        ...
        $this->addColumn ('response_action', array(
            ...
            'actions' => array(
                array(
                    ...
                    'url'     => array ('base' => 'adminhtml/brazil_nfce/response'),
                    'field'   => 'nfce_id',
                    'data-column' => 'action',
                ),
            ),
        ...
        $this->addColumn ('event_action', array(
            ...
            'actions' => array(
                array(
                    'caption' => Mage::helper ('brazil')->__('View'),
                    'url'     => array ('base' => 'adminhtml/brazil_nfce/event'),
                    'field'   => 'nfce_id',
                    'data-column' => 'action',
                ),
            ),
        ...
        $this->addExportType('*/*/exportCsv', Mage::helper('brazil')->__('CSV'));
        $this->addExportType('*/*/exportExcel', Mage::helper('brazil')->__('Excel XML'));
