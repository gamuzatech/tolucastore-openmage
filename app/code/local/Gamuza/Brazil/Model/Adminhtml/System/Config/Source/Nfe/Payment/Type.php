...
class Gamuza_Brazil_Model_Adminhtml_System_Config_Source_Nfe_Payment_Type
{
    ...
    public function toOptionArray()
    {
        $result = array(
            ...
            array ('value' => Gamuza_Brazil_Helper_Data::NFE_PAYMENT_TYPE_PIX,          'label' => Mage::helper ('brazil')->__('PIX')),
    ...
    public function toArray()
    {
        $result = array(
            ...
            Gamuza_Brazil_Helper_Data::NFE_PAYMENT_TYPE_PIX          => Mage::helper ('brazil')->__('PIX'),
