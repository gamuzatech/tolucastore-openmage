...
class Gamuza_Brazil_Model_Adminhtml_System_Config_Source_Nfe_Emission
{
    ...
    public function toOptionArray()
    {
        $result = array(
            ...
            array ('value' => Gamuza_Brazil_Helper_Data::NFE_EMISSION_CONTINGENCY_FS_IA,   'label' => Mage::helper ('brazil')->__('Contingency FS-IA')),
            ...
            array ('value' => Gamuza_Brazil_Helper_Data::NFE_EMISSION_CONTINGENCY_OFFLINE, 'label' => Mage::helper ('brazil')->__('Contingency Offline')),
        );
    ...
    public function toArray()
    {
        $result = array(
            ...
            Gamuza_Brazil_Helper_Data::NFE_EMISSION_CONTINGENCY_FS_IA   => Mage::helper ('brazil')->__('Contingency FS-IA'),
            ...
            Gamuza_Brazil_Helper_Data::NFE_EMISSION_CONTINGENCY_OFFLINE => Mage::helper ('brazil')->__('Contingency Offline'),
        );
