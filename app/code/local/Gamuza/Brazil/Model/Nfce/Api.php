...
class Gamuza_Brazil_Model_Nfce_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    public function items ($filters = array ())
    {
        ...
        foreach ($collection as $nfce)
        {
            $data = array (
                ...
                'authorized_at'   => $nfce->getAuthorizedAt (),
                'corrected_at'    => $nfce->getCorrectedAt (),
                'canceled_at'     => $nfce->getCanceledAt (),
                ...
                'customer_cellphone'  => strval ($nfce->getCustomerCellphone ()),
                ...
                'is_multi_payment' => boolval ($nfce->getIsMultiPayment ()),
                ...
                'pdv_card_id'     => intval ($nfce->getPdvCardId ()),
                // IBGE
    ...
    public function authorize ($orderIncrementId, $orderProtectCode, $info, $sent, $return, $data)
    {
        ...
        {
            $nfce->setAuthorizedAt ($response->getReceivedAt ());
        }
    ...
    public function canceled ($orderIncrementId, $orderProtectCode, $sent, $return, $data)
    {
        ...
        {
            $nfce->setCanceledAt ($event->getReceivedAt ());
        }
